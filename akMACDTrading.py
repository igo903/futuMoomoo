...
def main(code="600570", start_cash=1000000, stake=100, commission_fee=0.001):
    ...
    end_date = datetime(2023, 10, 25)  # 回测结束时间
...
if __name__ == '__main__':
    main(code="600570", start_cash=1000000, stake=100, commission_fee=0.001)